...
const options = {
	...
	headers: {
		...
		'X-RapidAPI-Key': '6ad41e9bc9msh982b9146b686d78p1225a9jsn61e5783b40e7',
		'X-RapidAPI-Host': 'part-of-speech-tagger.p.rapidapi.com'
	},
	body: '{"text":"أهلا كيف حالكم"}'
};

fetch('https://part-of-speech-tagger.p.rapidapi.com/pos-tagger', options)
